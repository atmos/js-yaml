...
describe 'yaml'
  ...
  describe 'list'
    ...
    describe 'with nested hash'
      it 'should work'
        assert('list.hash', [{ name: 'tj', github: 'visionmedia' }, { name: 'simon', github: 'sr' }])
      end
    end
  ...
  describe 'hash'
    ...
    describe 'with a nested list of hashes'
      it 'should work'
        assert('hash.list.hash', { hackers: [ { name: 'tj', github: 'visionmedia' }, {name: 'simon', github: 'sr' } ]})
      end
    end
